...
public class DataSourceFactory implements ObjectFactory {
    private static final Logger log = CCLogger.getLogger(DataSourceFactory.class);
    ...
    public Object getObjectInstance(Object obj, Name name, Context nameCtx,
        ...
        if (org.cc.tomcat.jdbc.pool.DataSource.class.getName().equals(ref.getClassName())) {
            ok = true;
        }
    ...
    public DataSource createDataSource(Properties properties,Context context, boolean XA) throws Exception {
        ...
        org.cc.tomcat.jdbc.pool.DataSource dataSource = XA?
                new org.cc.tomcat.jdbc.pool.XADataSource(poolProperties) :
                new org.cc.tomcat.jdbc.pool.DataSource(poolProperties);
