 ...
 */
package org.cc.tomcat.jdbc.pool.jmx;
...
import org.cc.tomcat.jdbc.pool.PoolConfiguration;
import org.cc.tomcat.jdbc.pool.PoolProperties.InterceptorDefinition;
import org.cc.tomcat.jdbc.pool.PoolUtilities;
import org.cc.tomcat.jdbc.pool.Validator;
...
public class ConnectionPool extends NotificationBroadcasterSupport
     ...
     * the connection pool
     */
    protected org.cc.tomcat.jdbc.pool.ConnectionPool pool = null;
    /**
    ...
    public ConnectionPool(org.cc.tomcat.jdbc.pool.ConnectionPool pool) {
        super();
        this.pool = pool;
    }

    public org.cc.tomcat.jdbc.pool.ConnectionPool getPool() {
        return pool;
    }
