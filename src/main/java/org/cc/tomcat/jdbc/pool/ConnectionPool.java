 ...
 */
package org.cc.tomcat.jdbc.pool;
...
public class ConnectionPool {
     ...
     * Logger
     */
    private static final Logger log = CCLogger.getLogger(ConnectionPool.class);
     ...
     */
    protected org.cc.tomcat.jdbc.pool.jmx.ConnectionPool jmxPool = null;
    ...
    protected void init(PoolConfiguration properties) throws SQLException {
        ...
        for (int i=0; i<proxies.length; i++) {
            try {
                ...
                if (jmxPool!=null) jmxPool.notify(org.cc.tomcat.jdbc.pool.jmx.ConnectionPool.NOTIFY_INIT, getStackTrace(x));
                close(true);
...
//===============================================================================
    ...
    protected void abandon(PooledConnection con) {
        ...
        try {
            ...
            if (jmxPool!=null) {
                jmxPool.notify(org.cc.tomcat.jdbc.pool.jmx.ConnectionPool.NOTIFY_ABANDON, trace);
            }
    ...
    protected void suspect(PooledConnection con) {
        ...
        try {
            ...
            if (jmxPool!=null) {
                jmxPool.notify(org.cc.tomcat.jdbc.pool.jmx.ConnectionPool.SUSPECT_ABANDONED_NOTIFICATION, trace);
            }
            con.setSuspect(true);
        } finally {
            con.unlock();
    ...
    private PooledConnection borrowConnection(int wait, String username, String password) throws SQLException {
        ...
        while (true) {
            ...
            if (maxWait==0 && con == null) { //no wait, return one if we have one
                if (jmxPool!=null) {
                    jmxPool.notify(org.cc.tomcat.jdbc.pool.jmx.ConnectionPool.POOL_EMPTY, "Pool empty - no wait.");
                }
            ...
            if (con == null) {
                if ((System.currentTimeMillis() - now) >= maxWait) {
                    if (jmxPool!=null) {
                        jmxPool.notify(org.cc.tomcat.jdbc.pool.jmx.ConnectionPool.POOL_EMPTY, "Pool empty - timeout.");
                    }
                    throw new PoolExhaustedException("[" + Thread.currentThread().getName()+"] " +
        ...
        if (con != null) {
            try {
                ...
                if (con.isSuspect()) {
                    ...
                    if (jmxPool!=null) {
                        jmxPool.notify(org.cc.tomcat.jdbc.pool.jmx.ConnectionPool.SUSPECT_RETURNED_NOTIFICATION,
     ...
     * @return the object implementing the {@link org.cc.tomcat.jdbc.pool.jmx.ConnectionPoolMBean} interface
     */
    public org.cc.tomcat.jdbc.pool.jmx.ConnectionPool getJmxPool() {
        return jmxPool;
    }
    ...
    protected void createMBean() {
        try {
            jmxPool = new org.cc.tomcat.jdbc.pool.jmx.ConnectionPool(this);
        } catch (Exception x) {
