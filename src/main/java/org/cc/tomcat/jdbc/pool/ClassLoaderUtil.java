...
public class ClassLoaderUtil {
    private static final Logger log = CCLogger.getLogger(ClassLoaderUtil.class);

    private static final boolean onlyAttemptFirstLoader =
        Boolean.parseBoolean(System.getProperty("org.cc.tomcat.jdbc.pool.onlyAttemptCurrentClassLoader", "false"));
