 ...
 */
package org.cc.tomcat.jdbc.pool.interceptor;
...
import org.cc.tomcat.jdbc.pool.ConnectionPool;
import org.cc.tomcat.jdbc.pool.DataSourceFactory;
import org.cc.tomcat.jdbc.pool.JdbcInterceptor;
import org.cc.tomcat.jdbc.pool.PoolConfiguration;
import org.cc.tomcat.jdbc.pool.PooledConnection;

/**
 * Interceptor that keep track of connection state to avoid roundtrips to the database.
 * The {@link org.cc.tomcat.jdbc.pool.ConnectionPool} is optimized to do as little work as possible.
...
public class ConnectionState extends JdbcInterceptor  {
    private static final Logger log = CCLogger.getLogger(ConnectionState.class);
