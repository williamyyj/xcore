...
import org.cc.tomcat.jdbc.pool.interceptor.ConnectionState;
import org.cc.tomcat.jdbc.pool.jmx.JmxUtil;
...
public class PooledConnection implements PooledConnectionMBean {
     ...
     * Logger
     */
    private static final Logger log = CCLogger.getLogger(PooledConnection.class);
     ...
     * @param password the password you wish to connect with, pass in null to accept the default username from {@link org.cc.tomcat.jdbc.pool.PoolConfiguration#getPassword()}
    ...
    protected void connectUsingDriver() throws SQLException {
        ...
        try {
            ...
            if (parent.jmxPool!=null) {
                parent.jmxPool.notify(org.cc.tomcat.jdbc.pool.jmx.ConnectionPool.NOTIFY_CONNECT,
...
//============================================================================
     ...
     * This timestamp can also be reset by the {@link org.cc.tomcat.jdbc.pool.interceptor.ResetAbandonedTimer#invoke(Object, java.lang.reflect.Method, Object[])}
