 ...
 */
package org.cc.tomcat.jdbc.naming;
...
import org.cc.tomcat.jdbc.pool.ClassLoaderUtil;

/**
 * Simple way of configuring generic resources by using reflection.
 * Example usage:
 * <pre><code>
 * &lt;Resource factory=&quot;org.cc.tomcat.jdbc.naming.GenericNamingResourcesFactory&quot;
 *              name=&quot;jdbc/test&quot;
...
public class GenericNamingResourcesFactory implements ObjectFactory {
    private static final Logger log = CCLogger.getLogger(GenericNamingResourcesFactory.class);
