...
package org.cc.org.mvel2.templates.res;
...
import static org.cc.org.mvel2.templates.util.TemplateTools.captureToEOS;
...
//        if (mark != contents.length) this.preExpression = subset(contents, ++mark, contents.length - mark);
  ...
  public Object eval(TemplateRuntime runtime, TemplateOutputStream appender, Object ctx, VariableResolverFactory factory) {
    if (preOffset != 0) {
      ...
      System.out.println("===== NamedIncludeNode :"+MVEL.eval(contents, includeStart, includeOffset, ctx, factory, String.class));
    if (next != null) {
