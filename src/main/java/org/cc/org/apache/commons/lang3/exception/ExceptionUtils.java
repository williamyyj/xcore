 ...
 */
package org.cc.org.apache.commons.lang3.exception;
...
import org.cc.org.apache.commons.lang3.ArrayUtils;
import org.cc.org.apache.commons.lang3.ClassUtils;
import org.cc.org.apache.commons.lang3.StringUtils;
import org.cc.org.apache.commons.lang3.Validate;
...
public class ExceptionUtils {
     ...
     *
     * <p>
     * Package private for accessibility by test suite.</p>
     */
    static final String WRAPPED_MARKER = " [wrapped] ";

    /**
     * <p>
     * The names of methods commonly used to access a wrapped exception.</p>
     */
    ...
    /**
     * <p>
     * Introspects the <code>Throwable</code> to obtain the cause.</p>
     *
     * <p>
     ...
     *
     * <p>
     * If none of the above is found, returns <code>null</code>.</p>
     *
     ...
     * {@link Throwable#getCause} instead
     */
    @Deprecated
    ...
    /**
     * <p>
     * Introspects the <code>Throwable</code> to obtain the root cause.</p>
     *
     * <p>
     * This method walks through the exception chain to the last element, "root"
     * of the tree, using {@link Throwable#getCause()}, and returns that
     * exception.</p>
     *
     * <p>
    ...
    /**
     * <p>
     * Finds a <code>Throwable</code> by method name.</p>
     *
    ...
    /**
     * <p>
     * Worker method for the <code>indexOfType</code> methods.</p>
     *
     * @param throwable the throwable to inspect, may be null
     * @param type the type to search for, subclasses match, null returns -1
     * @param fromIndex the (zero based) index of the starting position,
     * negative treated as zero, larger than chain size returns -1
     * @param subclass if <code>true</code>, compares with
     * {@link Class#isAssignableFrom(Class)}, otherwise compares using
     * references
     * @return index of the <code>type</code> within throwables nested within
     ...
     * this is the opposite order to the JDK1.4 display.</p>
     *
     * <p>
    ...
    /**
     * <p>
     * Prints a compact stack trace for the root cause of a throwable.</p>
     *
     * <p>
     * The compact stack trace starts with the root cause and prints stack
     * frames up to the place where it was caught and wrapped. Then it prints
    ...
    /**
     * <p>
     * Returns an array where each element is a line from the argument.</p>
     *
     * <p>
     ...
     * checked exception in a RuntimeException:      <code>
     ...
     * @return Never actually returned, this generic type matches any type which
     * the calling site requires. "Returning" the results of this method, as
     * done in the propagateExample above, will satisfy the java compiler
     ...
     * @param <R> The type of the returned value.
     * @return Never actually returned, this generic type matches any type which
     * the calling site requires. "Returning" the results of this method will
     * satisfy the java compiler requirement that all code paths return a value.
     * @since 3.5
