...
package org.cc.org.apache.log4j;
...
import org.cc.org.apache.log4j.config.PropertySetter;
import org.cc.org.apache.log4j.helpers.FileWatchdog;
import org.cc.org.apache.log4j.helpers.LogLog;
import org.cc.org.apache.log4j.helpers.OptionConverter;
import org.cc.org.apache.log4j.or.RendererMap;
import org.cc.org.apache.log4j.spi.Configurator;
import org.cc.org.apache.log4j.spi.Filter;
import org.cc.org.apache.log4j.spi.LoggerFactory;
import org.cc.org.apache.log4j.spi.LoggerRepository;
import org.cc.org.apache.log4j.spi.OptionHandler;
import org.cc.org.apache.log4j.spi.RendererSupport;
import org.cc.org.apache.log4j.spi.ThrowableRenderer;
import org.cc.org.apache.log4j.spi.ThrowableRendererSupport;
import org.cc.org.apache.log4j.spi.ErrorHandler;

/**
 * Allows the configuration of log4j from an external file. See
 * <b>{@link #doConfigure(String, LoggerRepository)}</b> for the expected
 * format.
 *
 * <p>
 * It is sometimes useful to see how log4j is reading configuration files. You
 * can enable log4j internal logging by defining the
 ...
 * org.apache.log4j.xml.DOMConfigurator DOMConfigurator} such as support custom
 * {@link org.cc.org.apache.log4j.spi.ErrorHandler ErrorHandlers}, nested
...
public class PropertyConfigurator implements Configurator {
    ...
    /**
     * * Key for specifying the {@link org.cc.org.apache.log4j.spi.LoggerFactory
     ...
     * cleared nor reset.</b> If you require a different behavior, then call {@link  LogManager#resetConfiguration
     ...
     * </pre> The first line defines the class name of the filter identified by
     * ID; subsequent lines with the same ID specify filter option - value
   ...
   You can customize the way an instance of Throwable is converted to String
     ...
     * {@link org.cc.org.apache.log4j.spi.ThrowableRenderer ThrowableRenderer}.
     *
     * <p>
     * The syntax is:
     *
     ...
     * {@link org.cc.org.apache.log4j.spi.LoggerFactory LoggerFactory} entry
     * specified by {@link #LOGGER_FACTORY_KEY}. If such an entry exists, an
     * attempt is made to create an instance using the default constructor. This
     * instance is used for subsequent Category creations within this
     * configurator.
     *
  ...
  void configureOptionHandler(OptionHandler oh, String prefix,
            ...
            if (key.startsWith(CATEGORY_PREFIX) || key.startsWith(LOGGER_PREFIX)) {
                ...
                if (hierarchy instanceof ThrowableRendererSupport) {
                    ThrowableRenderer tr = (ThrowableRenderer) OptionConverter.instantiateByKey(props,
                            ...
                            org.cc.org.apache.log4j.spi.ThrowableRenderer.class,
                            null);
                    if (tr == null) {
                        LogLog.error(
    ...
    Appender parseAppender(Properties props, String appenderName) {
        ...
        appender = (Appender) OptionConverter.instantiateByKey(props, prefix,
                org.cc.org.apache.log4j.Appender.class,
                null);
        if (appender == null) {
            LogLog.error(
