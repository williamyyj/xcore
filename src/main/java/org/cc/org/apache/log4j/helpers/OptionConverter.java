 ...
 */
package org.cc.org.apache.log4j.helpers;
...
public class OptionConverter {
     ...
     * <code>defaultValue</code> parameter, which may be
    ...
    public static
      ...
      // get a ref to the specified class' static method
            ...
            Class[] paramTypes = new Class[]{String.class,
                org.cc.org.apache.log4j.Level.class
            };
     ...
     * <code>props</code>. Then perform variable substitution on the found
     * value.
     *
     */
    public static
     ...
     * <code>superClass</code>. If that test fails or the object could not be
     * instantiated, then <code>defaultValue</code> is returned.
     *
     ...
     * </pre> will set <code>s</code> to "Value of inexistentKey is []"
     *
     * <p>
     ...
     *
     * <p>
     * The InputStream will be interpreted by a new instance of a log4j
     * configurator.
     * </p>
     * <p>
     ...
     * @param clazz The class name, of the log4j configurator which will parse
     * the <code>inputStream</code>. This must be a subclass of
     * {@link Configurator}, or null. If this value is null then a default
     * configurator of {@link PropertyConfigurator} is used.
     ...
     * {@link Configurator}, or null. If this value is null then a default
     * configurator of {@link PropertyConfigurator} is used, unless the filename
    ...
    static public
        ...
        if (clazz == null && filename != null && filename.endsWith(".xml")) {
            clazz = "hyweb.jo.org.apache.log4j.xml.DOMConfigurator";
        }
